...
def generate_sequence_wav(seq_id, syllable_files, output_dir):
    """
...
SEQUENCES_CSV_DIR = os.path.join(PARENT_DIR, "stimuli", "sequences_csv")
SYLLABLES_PATH    = os.path.join(PARENT_DIR, "stimuli", "syllables_renamed")
COMBINED_WAV_DIR  = os.path.join(PARENT_DIR, "stimuli", "combined_wav")
